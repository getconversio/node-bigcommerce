...
describe('Request: #BigCommerce', function(){
  ...
  describe('Helpers', function(){
    ...
    describe('post', function(){
      it('Should call the completeRequest with a method, path, callback and data', function(done){
        var request = new Request('api.bigcommerce.com'),
          post = sinon.stub(request, 'completeRequest', function(method, path, cb, data){
        ...
        request.post('/orders', {data:true}, function(){});
      });
    });
    ...
    describe('put', function(){
      it('Should call the completeRequest with a method, path, callback and data', function(done){
        ...
        request.put('/orders', {data:true}, function(){});
      });
    });
    ...
    describe('delete', function(){
      it('Should call the completeRequest with a method, path, callback and data', function(done){
        ...
        request.delete('/orders', {data:true}, function(){});
      });
    });

    describe('get', function(){
      it('Should call the completeRequest with a method, path and callback', function(done){
        var request = new Request('api.bigcommerce.com'),
          post = sinon.stub(request, 'completeRequest', function(method, path, cb, data){
